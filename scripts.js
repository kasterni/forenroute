!(function (t, e) {
    "object" == typeof exports && "object" == typeof module ?
        ...
        define([], e) :
        "object" == typeof exports ? (exports.inView = e()) : (t.inView = e());
})(this, function () {
    return (function (t) {
        function e(r) {
...
var subscribeForm = document.getElementById("popout-box");

inView("figure").on("enter", function (figure) {
    var img = figure.querySelector("img");

    if ("undefined" !== typeof img.dataset.src) {
        // If undefined is not equal to the img data-src

        figure.classList.add("is-loading");

        // Load a new image with the source retrieved from the data-src attribute
        newImg = new Image();
        newImg.src = img.dataset.src;

        newImg.addEventListener("load", function () {
            // Once loaded add the image to the container
            figure.innerHTML = "";
